  ...
  return (
    ...
    >
      <div className="mx-auto max-w-3xl text-center">
        ...
        <h1 className="text-balance text-5xl font-semibold tracking-tight text-foreground sm:text-6xl lg:text-7xl">Stop Overpaying. AI Guarantees You the Lowest Price, Every Single Time.</h1>

        <p className="mt-8 text-pretty text-lg leading-relaxed text-muted-foreground sm:text-xl">
          Skip the endless research and haggling. Nexus intelligently finds, compares, and negotiates your best price, so you save money effortlessly.</p>
        ...
        <div className="mt-12">
          {submitted ? (
            ...
            >
              ...
              >
                Get Early Access to AI-Guaranteed Savings
